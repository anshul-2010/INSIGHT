...
def analyze_image_with_full_pipeline(image_name, image_path, artifact_list):
    ...
    for artifact in artifact_list:
        try:
            ...
            results[artifact] = {"description": "Error", "score": 0.0, "verified": False, "confidence": 0.0, "justification": str(e)}
...
def generate_summary_report(image_results):
    ...
    for artifact, info in image_results['top_artifacts']:
        report += f"- {artifact} (score={info['score']:.2f}, confidence={info['confidence']:.2f}): {info['description']}\n"
    return report
