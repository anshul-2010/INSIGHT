# AuraSR: GAN-based Super-Resolution
# Borrowed idea from lucidrains/gigagan-pytorch repository.
...
command_str = "zip -r /content/Aura_SR_train.zip /content/Aura_SR_train"
command_args = shlex.split(command_str)
try:
    subprocess.run(command_args, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
    print("Successfully created zip file.")

except subprocess.CalledProcessError as e:
    print(f"Error creating zip file: {e.stderr}")

except FileNotFoundError:
    print("Error: The 'zip' command was not found. Make sure zip is installed and in your system's PATH.")